...
export default function FirebaseIcon({ size = 16, ...props }: SVGBaseProps) {
  return (
    <svg xmlns={'http://www.w3.org/2000/svg'} viewBox={'0 0 256 351'} xmlnsXlink={'http://www.w3.org/1999/xlink'} preserveAspectRatio={'xMidYMid'} widths={size} height={size} {...props}>
      <defs>
        ...
        <path d={'m1.253 280.732 1.605-3.131 99.353-188.518-44.15-83.475C54.392-1.283 45.074.474 43.87 8.188L1.253 280.732Z'} id={'firebase-a'} />
        <path d={'m134.417 148.974 32.039-32.812-32.039-61.007c-3.042-5.791-10.433-6.398-13.443-.59l-17.705 34.109-.53 1.744 31.678 58.556Z'} id={'firebase-c'} />
      </defs>
      ...
      <use fill={'#FFA712'} fillRule={'evenodd'} xlinkHref={'#firebase-a'} />
      <use filter={'url(#firebase-b)'} xlinkHref={'#firebase-a'} />
      ...
      <use fill={'#FFA50E'} fillRule={'evenodd'} xlinkHref={'#firebase-c'} />
      <use filter={'url(#firebase-d)'} xlinkHref={'#firebase-c'} />
